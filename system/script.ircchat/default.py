...
addon = xbmcaddon.Addon(id='script.Magic')
...
class irc_client(threading.Thread):
    ...
    def login(self, **kwargs):
        self.nickname = "$INFO[Skin.String(GTAG)]"
        self.username = "$INFO[Skin.String(GTAG)]"
        self.password = "Test"
        self.realname = "Test"
        self.hostname = "irc.freenode.net"
        self.servername = "XBMC"
        try:
...
class GUI(xbmcgui.WindowXMLDialog):
    def __init__( self, *args, **kwargs ):
        ...
        self.nickname = "$INFO[Skin.String(GTAG)]"
        self.username = "$INFO[Skin.String(GTAG)]"
        self.password = "$INFO[Skin.String(GTAG)]"
        self.channel = "XBMC"
        self.realname = "$INFO[Skin.String(GTAG)]"
        self.hostname = "irc.freenode.net"
        self.servername = "irc.freenode.net"
        self.port = "6667"
...
if params:
    ...
    channel = "XBMC"
    nickname = "$INFO[Skin.String(GTAG)]"
    username = "$INFO[Skin.String(GTAG)]"
    realname = "Test"
