        ...
        for iface in ifaces:
            ...
            try:
                ...
                for network in networks:
                  String1 = "SSID: %s, quality: %02d%%" % (
                        network.dot11Ssid.SSID[:network.dot11Ssid.SSIDLength], 
                        network.wlanSignalQuality)

                  String2 = "Interface: %s" % (iface.strInterfaceDescription)					
  		  xbmc.executebuiltin('Skin.SetString(Wifi1,' + String1 + ')')
		  xbmc.executebuiltin('Skin.SetString(Wifi2,' + String2 + ')')
